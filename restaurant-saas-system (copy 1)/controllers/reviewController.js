...
/**
 * متحكم التقييمات وآراء العملاء التجاري المربوط بـ MongoDB Atlas
 * Production-Ready Review Controller: Real Customer Names & Offline Data Binding
 */

// 1. إضافة تقييم جديد مع أخذ اسم العميل الحقيقي بدون أي مسميات افتراضية
exports.createReview = async (req, res) => {
    try {
        ...
        const review = await Review.create({
            ...
            userName: realCustomerName, // حفظ الاسم الحقيقي بدون ألقاب وهمية
        ...
        // إعادة حساب متوسط نجوم المنتج أوتوماتيكياً بـ MongoDB Aggregation
        ...
        res.status(201).json({
            success: true,
            message: '🎉 تم تسجيل تقييمك بنجاح بـ MongoDB Atlas!',
            review
        });
    } catch (error) {
...
// 4. الموافقة على نشر التقييم أو إخفائه بقرار من الإدارة
...
// 5. حذف تقييم نهائياً بـ MongoDB Atlas
